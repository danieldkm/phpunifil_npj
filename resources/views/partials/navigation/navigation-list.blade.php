...
<nav>
    <ul>
        ...
        <li><a href="/"><span class="nav-icon-hexa text-bloody-100">Pr</span>Principal</a></li>
        ...
        <ul>
            <li>
                ...
                <ul>
                    <li><a href="/npj/clientes"><span class="nav-icon-circle">Bu</span> Buscar</a></li>
                    <li><a href="/npj/clientes/form"><span class="nav-icon-circle">Cd</span> Cadastrar</a></li>
                </ul>
            </li>
            <li>
                <a href="#"><span class="nav-icon-hexa text-indigo-300">Pr</span> Processos</a>
                <ul>
                    <li><a href="/npj/processos"><span class="nav-icon-circle">Bu</span> Buscar</a></li>
                    <li><a href="/npj/processo/arquivado"><span class="nav-icon-circle">Aq</span> Arquivado</a></li>
                </ul>
            </li>
