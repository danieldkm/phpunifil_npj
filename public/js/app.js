...
var app = {
    ...
    navigation: function(){
        ...
        if(app.settings.navDetectAuto && !$(".app-navigation").hasClass("app-navigation-minimized")){
            ...
            $(".app-navigation a[href='"+path+"']").addClass("active").parents(".openable").addClass("open");
        }
        ...
        if(app.settings.navHorizontalDetectAuto){
            var path        = window.location.pathname,
                pathArray   = path.split("/"),
                page        = pathArray[pathArray.length - 1];
            $(".app-navigation-horizontal a[href='"+path+"']").parent("li").addClass("active").parents(".openable").addClass("active");
        }
